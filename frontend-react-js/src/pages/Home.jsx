    ...
    <>
      ...
      <main className="min-h-screen bg-[#F3F2EF] py-6">
        ...
        <button
          ...
          className="fixed bottom-4 right-3 sm:bottom-7 sm:right-7 z-50 w-11 h-11 sm:w-14 sm:h-14 rounded-full bg-[#0A66C2]/80 sm:bg-[#0A66C2] backdrop-blur-sm text-white flex items-center justify-center hover:bg-[#004182] active:scale-95 transition-all cursor-pointer"
        >
          <Plus className="w-5 h-5 sm:w-7 sm:h-7" strokeWidth={2.5} />
        </button>
